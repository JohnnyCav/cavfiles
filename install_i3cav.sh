...
sudo nala install gdm3 zsh rofi kitty picom nitrogen lxpolkit lxappearance nautilus dunst volumeicon-alsa network-manager-gnome arandr blueman pavucontrol xbacklight imagemagick -y
